...
const PrivacyPolicy = () => {
  return (
    <div className='main-cart'>
      ...
      <div className='container header-Privacy'>
        <h3 className='mb-3'>Chính sách bảo mật</h3>
        <div className='mb-3'>
          <p>
            Cám ơn quý khách đã quan tâm và truy cập vào website <a href="/" style={{ textDecoration: "none" }}><b>sportszone.vn</b></a>. Chúng tôi tôn trọng và cam kết sẽ bảo mật những thông tin mang tính riêng tư của Quý khách.
          </p>
          <p>
        ...
        <div className='mb-3'>
          <h6 className='mb-3'>1. THU THẬP THÔNG TIN CÁ NHÂN</h6>
          <p>
        ...
        <div className='mb-3'>
          <h6 className='mb-3'>2. BẢO MẬT</h6>
          <p>
        ...
        <div className='mb-3'>
          <h6 className='mb-3'>3. QUYỀN LỢI KHÁCH HÀNG</h6>
          <p>
