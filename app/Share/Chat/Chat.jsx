...
function Chat(props) {
    ...
    const id_admin = '63b8fe99ef8f318ba6417c3a'
    ...
    const URL_CHAT = 'http://localhost:3003/messenger'
    ...
    const handlerSend = () => {
        ...
        const postData = async () => {
            ...
            const response = await axios.post(`${URL_CHAT}/send${query}`)
    ...
    useEffect(() => {
        if (load) {
            const fetchData = async () => {
                ...
                const response = await axios.get(`${URL_CHAT}/${query}`)
                        ...
                        <div style={{ width: '100%' }}>
                            <div className="card card-bordered fix_boderChat">
                                <div className="card-header">
                                    <h4 className="card-title"><strong>Hỗ trợ</strong></h4>
                                    {/* <a className="btn btn-xs btn-secondary" href="#">Let's Chat App</a> */}
                                </div>
                                {/* khung chat */}
                                ...
                                <div className="publisher bt-1 border-light">
                                    ...
                                    <a href='/' onClick={handlerSend} className="publisher-btn text-info" data-abc="true">
